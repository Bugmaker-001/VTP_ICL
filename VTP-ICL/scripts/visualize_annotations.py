...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Visualize train annotations and save images.")
...
def main() -> None:
    ...
    print(f"Visualization finished: {len(manifest)} images")
    print(f"Manifest file: {Path(args.manifest_out).resolve()}")
